...
export default function Header() {
  ...
  const navigation = [
    ...
    { name: 'Event Explorer', href: '/events', icon: Palette },
    { name: 'Audio Zone', href: '/audio', icon: Palette },
    { name: 'Timeline', href: '/timeline', icon: Palette },
    { name: 'Submit', href: '/submit', icon: Palette },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button className="flex items-center space-x-2 bg-cultural-blue-100 text-cultural-blue-800 px-4 py-2 rounded-lg hover:bg-cultural-blue-200 transition-colors duration-200">
              <MessageCircle className="w-4 h-4" />
              <span className="text-sm font-medium">Ask Cultura</span>
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-cultural-beige-200 animate-slide-up">
            <div className="flex flex-col space-y-4">
              ...
              <button className="flex items-center space-x-2 bg-cultural-blue-100 text-cultural-blue-800 px-4 py-2 rounded-lg hover:bg-cultural-blue-200 transition-colors duration-200 w-fit">
                <MessageCircle className="w-4 h-4" />
                <span className="text-sm font-medium">Ask Cultura</span>
              </button>
            </div>
